  ...
  const educationList = [
    {
      ...
      cgpa: "CGPA - 8.2",
      description:
        "Post-graduate studies specializing in advanced computer science methodologies, algorithms, and software engineering. Focused research on web technologies and user experience.",
    },
    {
      ...
      cgpa: "CGPA - 7.3",
      description:
        "Undergraduate curriculum building foundational concepts in programming languages, data structures, databases, and general computer science theory.",
    },
  ];
