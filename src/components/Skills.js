  ...
  const skillGroups = [
    {
      ...
      skills: ["HTML5", "CSS3", "JavaScript (ES6+)", "Bootstrap", "Tailwind CSS", "React.js", "Responsive Web Design"]
    },
    {
      ...
      skills: ["DOM Manipulation", "React Hooks", "Component Architecture", "REST API Basics", "JSON", "json server."]
    },
    {
      category: "Database",
      icon: (
