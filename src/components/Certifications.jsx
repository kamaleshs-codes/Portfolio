...
export default function Certifications() {
  const certList = [
    ...
    {
      title: "Data Science (Campus Program)",
      issuer: "Sri Sankara Arts and Science College",
      ...
      icon: (
        <svg
          ...
          <path
            ...
            strokeLinejoin='round'
            strokeWidth='1.5'
            d='M12 8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 8c0-1.1.9-2 2-2h8c1.1 0 2 .9 2 2v2H6v-2z'
          />
        </svg>
      ),
    },
